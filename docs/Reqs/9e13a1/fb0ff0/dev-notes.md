...
## 产出文件
- [backend/app/models/budget.py](/app#repo?file=backend/app/models/budget.py) (1919 chars)
- [backend/app/schemas/budget.py](/app#repo?file=backend/app/schemas/budget.py) (4581 chars)
- [backend/app/routers/budgets.py](/app#repo?file=backend/app/routers/budgets.py) (7487 chars)
...
- [backend/tests/test_budgets.py](/app#repo?file=backend/tests/test_budgets.py) (18980 chars)
...
### backend/app/models/budget.py (新建, 1919 chars)
```
...
### backend/app/schemas/budget.py (新建, 4581 chars)
```
...
### backend/app/routers/budgets.py (新建, 7487 chars)
```
...
### backend/tests/test_budgets.py (新建, 18980 chars)
```
+ import pytest
+ from datetime import datetime
+ from decimal import Decimal
