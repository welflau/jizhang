...
## 产出文件
- [backend/app/models/budget.py](/app#repo?file=backend/app/models/budget.py) (2098 chars)
...
- [backend/app/api/routes/budgets.py](/app#repo?file=backend/app/api/routes/budgets.py) (7689 chars)
- [backend/app/services/budget_service.py](/app#repo?file=backend/app/services/budget_service.py) (10021 chars)
- [backend/app/schemas/budget.py](/app#repo?file=backend/app/schemas/budget.py) (3460 chars)
...
### backend/app/models/budget.py (新建, 2098 chars)
```
...
### backend/app/api/routes/budgets.py (新建, 7689 chars)
```
...
### backend/app/services/budget_service.py (新建, 10021 chars)
```
+ from datetime import datetime
+ from typing import List, Optional
+ from sqlalchemy.orm import Session
...
### backend/app/schemas/budget.py (新建, 3460 chars)
```
